...
var Factory = function () {
    ...
    return {
        ...
        setModule: function (moduleName, relativePath) {
            ...
            _modulesPath[moduleName] = path.join(this.getApplicationRoot(), relativePath);
        },
         ...
         * @param relativePath
         */
        setModuleAbsolutePath: function (moduleName, absolutePath) {
            fs.realpathSync(absolutePath);
            _modulesPath[moduleName] = absolutePath;
        },
        ...
        getHelper: function (name, params) {
            ...
            if (name in _helperClasses) {
                ...
                ClassObject = require(path.join(this.getModulePath(module), 'lib', 'helpers', className + 'Helper'));

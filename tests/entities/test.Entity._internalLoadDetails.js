...
describe("Object: _internalLoadDetails", function() {
    ...
    it("Check isLoad after loading", function(done) {
        var mockDriver = {
            loadEntity : function(callback) {
                callback(null, {'_id' : 1, 'name' : 'test 1', '_ts' : {'created' : new Date(), 'modified' : new Date(), 'deleted' : null}});
            }
        };
        var mockLoad = function(deatils, callback) {
            callback(null, {'_id' : 1, 'name' : 'test 1', '_ts' : {'created' : new Date(), 'modified' : new Date(), 'deleted' : null}});
        };
    ...
    it("Load entity from driver Exists", function(done) {
        var loadStruct = {'_id' : 1, 'name' : 'test 1', '_ts' : {'created' : new Date(), 'modified' : new Date(), 'deleted' : null}};
        var mockDriver = {
            loadEntity : function() {
                return Q(loadStruct);
            }
